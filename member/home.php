<?php
    ...
    $balance = showBalance($memberID, $clubID);
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                ...
                                                <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                    <h5 class="mb-0 text-danger font-weight-bold"><?php echo $balance ?></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                ...
                                                <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                    <h5 class="mb-0 text-danger font-weight-bold"><?php echo $tableID ?></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                ...
                                                <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                    <h5 class="mb-0 text-danger font-weight-bold">TODO:還沒想到怎麼獲取</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                ...
                                                <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                    <h5 class="mb-0 text-danger font-weight-bold"><?php echo $seatID ?></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                    <h5 class="mb-0 text-danger font-weight-bold">
                                                        <?php
                                                            $result = showScore($tableID, $seatID);
                                                            echo $result;
                                                        ?>
                                                    </h5>
                                                </div>
                            ...
                            <div class="col-12">
                                <div class="cart">
                                    <div class="card-body">
                                        <div class="align-items-center">
                                            <div class="d-flex align-items-center">
                                                <input id="nextRoundButton" type="button" class="btn btn-primary btn-block" onclick="location.href='./nextRound.blade.php'" value="開始下一場"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
