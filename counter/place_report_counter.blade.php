                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb p-0 mb-0">
                                        <li class="breadcrumb-item"><a href="counter">主頁</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">場地報表</li>
                                    </ol>
                                </nav>
                            </div>
                            <a href="counter"
                                ...
                                <div class="card card-block card-stretch">
                                    <div class="card-body p-0">
                                        <div class="d-flex justify-content-between align-items-center p-3">
                                            ...
                                            <button type="button" class="mt-2 btn btn-primary btn-with-icon" name="submit">確認查詢日期</button>
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table data-table table-bordered ">
                                                <thead class="table-color-heading">
                                                    <tr class="text-light">
                                                        <th scope="col">
                                                            <label class="" style="width: 140px;">有效遊戲場次總數</label>
                                                        </th>
                                                        <th scope="col">
                                                            <label class="" style="width: 110px;">服務費收入</label>
                                                        </th>
                                                        <th scope="col">
                                                            <label class="" style="width: 110px;">場地金幣收入</label>
                                                        </th>
                                                        <th scope="col">
                                                            <label class="" style="width: 100px;">會員儲值</label>
                                                        </th>
                                                        <!-- <th scope="col">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="white-space-no-wrap">
                                                        ...
                                                        <td class="text-right">7844</td>
                                                        <td class="text-right">5648</td>
                                                        <td class="text-right">40000</td>
                                                        <!-- <td>100</td> -->
                                                        <td>
                                                            <div class="d-flex justify-content-end align-items-center">
                                                                <a class="" data-toggle="tooltip" data-placement="top" title="" data-original-title="View" href="game_report_counter">
                                                                &nbsp&nbsp&nbsp查看&nbsp&nbsp                                                 
                                                                </a>
                                                            </div>
                                                        </td>
