                ...
                <div class="row">            
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                                ...
                                <a href="game_report_counter" class="btn btn-primary btn-sm d-flex align-items-center justify-content-between">
                                ...
                                <table class="table data-table mb-0">
                                    ...
                                    <tbody>
                                        <tr class="white-space-no-wrap">
                                            ...
                                            <td>100</td>
                                            <td>100</td>
                                            <td><a href="game_report_view_round_counter">查看</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
